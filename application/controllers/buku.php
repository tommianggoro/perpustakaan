...
class Buku extends CI_Controller {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($cek->num_rows() > 0) {
                ...
                $this->template->display('buku/tambah', $data);
                 ...
                 // jika kode buku belum ada, maka simpan
                ...
                $info = array('kode_buku' => $this->input->post('kode'), 'judul' => $this->input->post('judul'), 'pengarang' => $this->input->post('pengarang'), 'klasifikasi' => $this->input->post('klasifikasi'), 'image' => $gambar);
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $info = array('judul' => $this->input->post('judul'), 'pengarang' => $this->input->post('pengarang'), 'klasifikasi' => $this->input->post('klasifikasi'), 'image' => $gambar);
