...
class Laporan extends CI_Controller {
    ...
    function cari_pinjaman() {
        ...
        $data['lap'] = $this->m_laporan->detailpeminjaman(strtotime($tanggal1), strtotime($tanggal2))->result();
    ...
    function cari_pengembalian() {
        ...
        $tanggal1 = $this->input->post('tanggal1');
        $tanggal2 = $this->input->post('tanggal2');
        $data['lap'] = $this->m_laporan->detailpengembalian(strtotime($tanggal1), strtotime($tanggal2))->result();
