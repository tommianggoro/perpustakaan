...
<a href="<?php echo site_url('petugas/tambahpetugas');?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
<?php echo $message;?>
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                ...
                success:function(html){
                    location.href="<?php echo site_url('petugas/index/delete_success');?>";
                }
            });
        });
    });
